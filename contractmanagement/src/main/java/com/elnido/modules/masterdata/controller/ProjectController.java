...
public class ProjectController {
    ...
    public Result<IPage<Project>> pagedSearchProjects(Project project,
        ...
        QueryWrapper<Project> queryWrapper = QueryGenerator.initQueryWrapper(project, httpServletRequest.getParameterMap());
        IPage<Project> queriedProjectIPage = projectService.page(projectIPage, queryWrapper);
